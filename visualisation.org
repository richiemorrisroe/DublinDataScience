...
## pobal_locs <- select(ppr_plus_pobal, latitude, longitude)
...
#+END_SRC
#+BEGIN_SRC R :session :results output graphics :file line1.png
...
[[file:line1.png]]
* Flipped Line Chart
#+BEGIN_SRC R :session :results output graphics :file line2.png
